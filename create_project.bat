...
ECHO 5. Visual Studio 2015 Solution (Emscripten)
ECHO 6. Visual Studio 2015 Solution With vaultSDK Repository (Emscripten)
...
:FIVE
 ECHO Creating VS2015 Project for Emscripten...
 3rdParty\udcore\bin\premake-bin\premake5.exe vs2015 --os=emscripten
 GOTO END
