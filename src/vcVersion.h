...
// This is the Windows file version array
#define VCVERSION_VERSION_ARRAY 0,1,1,VCVERSION_BUILD_NUMBER

// This is the standard version number string [Major].[Minor].[Revision].[BuildID]
#define VCVERSION_VERSION_STRING "0.1.1." VCSTRINGIFY(VCVERSION_BUILD_NUMBER)
