...
{
    main0_out out = {};
    float3 _58 = (normalTexture.sample(normalSampler, in.in_var_TEXCOORD3).xyz * float3(2.0)) - float3(1.0);
    ...
    out.out_var_SV_Target1 = float4(_58.xy, in.in_var_TEXCOORD2.x, ((step(0.0, _58.z) * 2.0) - 1.0) * (((in.in_var_TEXCOORD1.x / in.in_var_TEXCOORD1.y) * (1.0 / (u_cameraPlaneParams.u_clipZFar - u_cameraPlaneParams.u_clipZNear))) + (u_cameraPlaneParams.u_clipZNear * (-0.5))));
    return out;
}
