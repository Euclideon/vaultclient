...
fragment main0_out main0(main0_in in [[stage_in]], texture2d<float> colourTexture [[texture(0)]], sampler colourSampler [[sampler(0)]])
{
    ...
    switch (0u)
    {
        default:
        {
            ...
            _99 = float4(in.in_var_COLOR0.xyz, fast::max(in.in_var_COLOR1.w, ((((1.0 - _48) + (_63 * step(colourTexture.sample(colourSampler, in.in_var_TEXCOORD1).x - _49, -9.9999997473787516355514526367188e-06))) + (_63 * step(colourTexture.sample(colourSampler, in.in_var_TEXCOORD2).x - _49, -9.9999997473787516355514526367188e-06))) + (_63 * step(colourTexture.sample(colourSampler, in.in_var_TEXCOORD3).x - _49, -9.9999997473787516355514526367188e-06))) + (_63 * step(colourTexture.sample(colourSampler, in.in_var_TEXCOORD4).x - _49, -9.9999997473787516355514526367188e-06))) * in.in_var_COLOR0.w);
            break;
        }
    }
