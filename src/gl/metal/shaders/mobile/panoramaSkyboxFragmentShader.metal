...
fragment main0_out main0(main0_in in [[stage_in]], constant type_u_EveryFrame& u_EveryFrame [[buffer(0)]], texture2d<float> albedoTexture [[texture(0)]], sampler albedoSampler [[sampler(0)]])
{
    ...
    out.out_var_SV_Target = albedoTexture.sample(albedoSampler, (float2(atan2(_45.x, _45.y) + 3.1415927410125732421875, acos(_45.z)) * float2(0.15915493667125701904296875, 0.3183098733425140380859375)));
    return out;
}
