...
// Skybox Fragment Shader - g_vcSkyboxFragmentShader
  struct SFSUniforms
  {
  ...
  fragment float4
  skyboxFragmentShader(SVSOutput in [[stage_in]], constant SFSUniforms& uSFS [[buffer(1)]], texture2d<float, access::sample> SFSimg [[texture(0)]], sampler SFSsampler [[sampler(0)]])
  {
    // work out 3D point
