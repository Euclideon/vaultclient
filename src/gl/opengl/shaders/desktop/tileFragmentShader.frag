...
void main()
{
    vec3 _61 = (vec3(texture(SPIRV_Cross_CombinednormalTexturenormalSampler, in_var_TEXCOORD3).xyz) * vec3(2.0)) - vec3(1.0);
    ...
    out_var_SV_Target1 = vec4(_61.xy, in_var_TEXCOORD2.x, ((step(0.0, _61.z) * 2.0) - 1.0) * (((in_var_TEXCOORD1.x / in_var_TEXCOORD1.y) * (1.0 / (u_cameraPlaneParams.u_clipZFar - u_cameraPlaneParams.u_clipZNear))) + (u_cameraPlaneParams.u_clipZNear * (-0.5))));
}
