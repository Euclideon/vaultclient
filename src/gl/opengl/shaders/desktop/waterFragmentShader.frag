...
void main()
{
    vec3 _85 = normalize(((texture(SPIRV_Cross_Combinedu_normalMapsampler0, in_var_TEXCOORD0).xyz * vec3(2.0)) - vec3(1.0)) + ((texture(SPIRV_Cross_Combinedu_normalMapsampler0, in_var_TEXCOORD1).xyz * vec3(2.0)) - vec3(1.0)));
