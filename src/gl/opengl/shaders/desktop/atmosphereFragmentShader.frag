...
void main()
{
    ...
    vec3 _131 = normalize(in_var_TEXCOORD1);
    vec4 _135 = texture(SPIRV_Cross_CombinedsceneColourTexturesceneColourSampler, in_var_TEXCOORD0);
    vec4 _139 = texture(SPIRV_Cross_CombinedsceneNormalTexturesceneNormalSampler, in_var_TEXCOORD0);
    vec4 _143 = texture(SPIRV_Cross_CombinedsceneDepthTexturesceneDepthSampler, in_var_TEXCOORD0);
    float _144 = _143.x;
    float _149 = u_cameraPlaneParams.s_CameraFarPlane - u_cameraPlaneParams.s_CameraNearPlane;
    vec2 _167 = _139.zw;
    vec3 _172 = vec3(_139.zw, float(int(sign(_139.y))) * sqrt(1.0 - dot(_167, _167)));
    vec3 _175 = pow(abs(_135.xyz), vec3(2.2000000476837158203125));
    bvec3 _178 = bvec3(length(_172) == 0.0);
    vec3 _179 = vec3(_178.x ? vec3(0.0, 0.0, 1.0).x : _172.x, _178.y ? vec3(0.0, 0.0, 1.0).y : _172.y, _178.z ? vec3(0.0, 0.0, 1.0).z : _172.z);
    ...
    vec3 _187 = u_fragParams.u_camera.xyz + (_131 * _185);
    vec3 _188 = u_fragParams.u_camera.xyz - u_fragParams.u_earthCenter.xyz;
    ...
    vec3 _207 = _203 - u_fragParams.u_earthCenter.xyz;
    vec3 _208 = normalize(_207);
    vec3 _217 = _179;
    _217.y = _179.y * (-1.0);
    vec3 _218 = mat3(normalize(cross(u_fragParams.u_earthNorth.xyz, _208)), u_fragParams.u_earthNorth.xyz, _208) * _217;
    bool _219 = _144 < 0.75;
    vec3 _807;
    if (_219)
    {
        vec3 _222 = _187 - u_fragParams.u_earthCenter.xyz;
        ...
        vec4 _240 = texture(SPIRV_Cross_CombinedirradianceTextureirradianceSampler, vec2(0.0078125 + (((_227 * 0.5) + 0.5) * 0.984375), 0.03125 + (((_225 - u_fragParams.u_earthCenter.w) / _229) * 0.9375)));
        float _247 = u_fragParams.u_earthCenter.w / _225;
        float _253 = _118 * _118;
        float _255 = sqrt(_253 - _194);
        float _256 = _225 * _225;
        float _259 = sqrt(max(_256 - _194, 0.0));
        float _270 = _118 - _225;
        vec4 _283 = texture(SPIRV_Cross_CombinedtransmittanceTexturetransmittanceSampler, vec2(0.001953125 + (((max(((-_225) * _227) + sqrt(max((_256 * ((_227 * _227) - 1.0)) + _253, 0.0)), 0.0) - _270) / ((_259 + _255) - _270)) * 0.99609375), 0.0078125 + ((_259 / _255) * 0.984375)));
        float _300 = max(0.0, min(0.0, _185));
        vec3 _303 = normalize(_222 - _188);
        ...
        switch (0u)
        {
            ...
            {
                _339 = (2.0 * _321) * _322;
                float _344 = clamp(sqrt((_327 * (_327 + _339)) + _329), u_fragParams.u_earthCenter.w, _118);
                float _347 = clamp((_320 + _327) / _344, -1.0, 1.0);
                if (_335)
                {
                    float _405 = -_347;
                    float _406 = _344 * _344;
                    float _409 = sqrt(max(_406 - _194, 0.0));
                    float _420 = _118 - _344;
                    float _434 = -_322;
                    float _437 = sqrt(max(_329 - _194, 0.0));
                ...
                {
                    float _353 = sqrt(max(_329 - _194, 0.0));
                    float _361 = _118 - _321;
                    float _375 = _344 * _344;
                    float _378 = sqrt(max(_375 - _194, 0.0));
        ...
        float _467 = sqrt(max(_329 - _194, 0.0));
        ...
        float _519 = (max((_511 * _324) + sqrt(max((_194 * ((_324 * _324) - 1.0)) + _253, 0.0)), 0.0) - _229) / _518;
        float _521 = (0.415823996067047119140625 * u_fragParams.u_earthCenter.w) / _518;
        float _528 = 0.015625 + ((max(1.0 - (_519 / _521), 0.0) / (1.0 + _519)) * 0.96875);
        float _530 = (_325 + 1.0) * 3.5;
        float _531 = floor(_530);
        float _532 = _530 - _531;
        float _536 = _531 + 1.0;
        vec4 _542 = texture(SPIRV_Cross_CombinedscatteringTexturescatteringSampler, vec3((_531 + _528) * 0.125, _506, _470));
        float _543 = 1.0 - _532;
        vec4 _546 = texture(SPIRV_Cross_CombinedscatteringTexturescatteringSampler, vec3((_536 + _528) * 0.125, _506, _470));
        vec4 _548 = (_542 * _543) + (_546 * _532);
        vec3 _549 = _548.xyz;
        vec3 _562;
        switch (0u)
        {
        ...
        float _564 = max(_327 - _300, 0.0);
        float _569 = clamp(sqrt((_564 * (_564 + _339)) + _329), u_fragParams.u_earthCenter.w, _118);
        float _570 = _320 + _564;
        float _573 = (_323 + (_564 * _325)) / _569;
        float _574 = _569 * _569;
        float _577 = sqrt(max(_574 - _194, 0.0));
        ...
        float _627 = (max((_511 * _573) + sqrt(max((_194 * ((_573 * _573) - 1.0)) + _253, 0.0)), 0.0) - _229) / _518;
        float _634 = 0.015625 + ((max(1.0 - (_627 / _521), 0.0) / (1.0 + _627)) * 0.96875);
        vec4 _642 = texture(SPIRV_Cross_CombinedscatteringTexturescatteringSampler, vec3((_531 + _634) * 0.125, _616, _580));
        vec4 _645 = texture(SPIRV_Cross_CombinedscatteringTexturescatteringSampler, vec3((_536 + _634) * 0.125, _616, _580));
        vec4 _647 = (_642 * _543) + (_645 * _532);
        vec3 _648 = _647.xyz;
        vec3 _661;
        switch (0u)
        {
        ...
        if (_300 > 0.0)
        {
            ...
            switch (0u)
            {
                default:
                {
                    float _668 = clamp(_570 / _569, -1.0, 1.0);
                    if (_335)
                    {
                        float _717 = -_668;
        ...
        vec3 _770 = _549 - (_768 * _648);
        vec3 _772 = _562 - (_768 * _661);
        float _773 = _772.x;
        float _774 = _770.x;
        vec3 _789;
        switch (0u)
    ...
    if (_198)
    {
        ...
        vec4 _828 = texture(SPIRV_Cross_CombinedirradianceTextureirradianceSampler, vec2(0.0078125 + (((_815 * 0.5) + 0.5) * 0.984375), 0.03125 + (((_813 - u_fragParams.u_earthCenter.w) / _817) * 0.9375)));
        float _835 = u_fragParams.u_earthCenter.w / _813;
        float _841 = _118 * _118;
        float _843 = sqrt(_841 - _194);
        float _844 = _813 * _813;
        float _847 = sqrt(max(_844 - _194, 0.0));
        float _858 = _118 - _813;
        vec4 _871 = texture(SPIRV_Cross_CombinedtransmittanceTexturetransmittanceSampler, vec2(0.001953125 + (((max(((-_813) * _815) + sqrt(max((_844 * ((_815 * _815) - 1.0)) + _841, 0.0)), 0.0) - _858) / ((_847 + _843) - _858)) * 0.99609375), 0.0078125 + ((_847 / _843) * 0.984375)));
        vec3 _889 = normalize(_207 - _188);
        ...
        switch (0u)
        {
            ...
            {
                _925 = (2.0 * _907) * _908;
                float _930 = clamp(sqrt((_913 * (_913 + _925)) + _915), u_fragParams.u_earthCenter.w, _118);
                float _933 = clamp((_906 + _913) / _930, -1.0, 1.0);
                if (_921)
                {
                    float _991 = -_933;
                    float _992 = _930 * _930;
                    float _995 = sqrt(max(_992 - _194, 0.0));
                    float _1006 = _118 - _930;
                    float _1020 = -_908;
                    float _1023 = sqrt(max(_915 - _194, 0.0));
                ...
                {
                    float _939 = sqrt(max(_915 - _194, 0.0));
                    float _947 = _118 - _907;
                    float _961 = _930 * _930;
                    float _964 = sqrt(max(_961 - _194, 0.0));
        ...
        float _1053 = sqrt(max(_915 - _194, 0.0));
        ...
        float _1105 = (max((_1097 * _910) + sqrt(max((_194 * ((_910 * _910) - 1.0)) + _841, 0.0)), 0.0) - _817) / _1104;
        float _1107 = (0.415823996067047119140625 * u_fragParams.u_earthCenter.w) / _1104;
        float _1114 = 0.015625 + ((max(1.0 - (_1105 / _1107), 0.0) / (1.0 + _1105)) * 0.96875);
        float _1116 = (_911 + 1.0) * 3.5;
        float _1117 = floor(_1116);
        float _1118 = _1116 - _1117;
        float _1122 = _1117 + 1.0;
        vec4 _1128 = texture(SPIRV_Cross_CombinedscatteringTexturescatteringSampler, vec3((_1117 + _1114) * 0.125, _1092, _1056));
        float _1129 = 1.0 - _1118;
        vec4 _1132 = texture(SPIRV_Cross_CombinedscatteringTexturescatteringSampler, vec3((_1122 + _1114) * 0.125, _1092, _1056));
        vec4 _1134 = (_1128 * _1129) + (_1132 * _1118);
        vec3 _1135 = _1134.xyz;
        vec3 _1148;
        switch (0u)
        {
            default:
        ...
        float _1149 = max(_913, 0.0);
        float _1154 = clamp(sqrt((_1149 * (_1149 + _925)) + _915), u_fragParams.u_earthCenter.w, _118);
        float _1155 = _906 + _1149;
        float _1158 = (_909 + (_1149 * _911)) / _1154;
        float _1159 = _1154 * _1154;
        float _1162 = sqrt(max(_1159 - _194, 0.0));
        ...
        float _1212 = (max((_1097 * _1158) + sqrt(max((_194 * ((_1158 * _1158) - 1.0)) + _841, 0.0)), 0.0) - _817) / _1104;
        float _1219 = 0.015625 + ((max(1.0 - (_1212 / _1107), 0.0) / (1.0 + _1212)) * 0.96875);
        vec4 _1227 = texture(SPIRV_Cross_CombinedscatteringTexturescatteringSampler, vec3((_1117 + _1219) * 0.125, _1201, _1165));
        vec4 _1230 = texture(SPIRV_Cross_CombinedscatteringTexturescatteringSampler, vec3((_1122 + _1219) * 0.125, _1201, _1165));
        vec4 _1232 = (_1227 * _1129) + (_1230 * _1118);
        vec3 _1233 = _1232.xyz;
        vec3 _1246;
        switch (0u)
        {
            default:
        ...
        vec3 _1248 = _1135 - (_1050 * _1233);
        vec3 _1250 = _1148 - (_1050 * _1246);
        float _1251 = _1250.x;
        float _1252 = _1248.x;
        vec3 _1267;
        switch (0u)
    ...
    switch (0u)
    {
        default:
        {
            ...
            float _1325 = sqrt(max(_1314 - _194, 0.0));
            float _1333 = _118 - _1308;
            float _1336 = (_1325 + _1322) - _1333;
            float _1338 = _1325 / _1322;
            vec4 _1346 = texture(SPIRV_Cross_CombinedtransmittanceTexturetransmittanceSampler, vec2(0.001953125 + (((max(((-_1308) * _1309) + sqrt(max(_1317 + _1292, 0.0)), 0.0) - _1333) / _1336) * 0.99609375), 0.0078125 + (_1338 * 0.984375)));
            vec3 _1347 = _1346.xyz;
            ...
            float _1398 = (max(((-u_fragParams.u_earthCenter.w) * _1311) + sqrt(max((_194 * ((_1311 * _1311) - 1.0)) + _1292, 0.0)), 0.0) - _1395) / _1397;
            float _1407 = 0.015625 + ((max(1.0 - (_1398 / ((0.415823996067047119140625 * u_fragParams.u_earthCenter.w) / _1397)), 0.0) / (1.0 + _1398)) * 0.96875);
            float _1409 = (_1312 + 1.0) * 3.5;
            float _1410 = floor(_1409);
            float _1411 = _1409 - _1410;
            vec4 _1421 = texture(SPIRV_Cross_CombinedscatteringTexturescatteringSampler, vec3((_1410 + _1407) * 0.125, _1384, _1351));
            vec4 _1425 = texture(SPIRV_Cross_CombinedscatteringTexturescatteringSampler, vec3(((_1410 + 1.0) + _1407) * 0.125, _1384, _1351));
            vec4 _1427 = (_1421 * (1.0 - _1411)) + (_1425 * _1411);
            vec3 _1428 = _1427.xyz;
            vec3 _1441;
            switch (0u)
            {
                default:
    ...
    vec3 _1480 = pow(abs(vec3(1.0) - exp(((-mix(mix(_1462, _1283, vec3(float(_198))), _807, vec3(float(_219) * min(1.0, 1.0 - smoothstep(0.64999997615814208984375, 0.75, _144))))) / u_fragParams.u_whitePoint.xyz) * u_fragParams.u_camera.w)), vec3(0.4545454680919647216796875));
    vec4 _1482 = vec4(_1480.x, _1480.y, _1480.z, _110.w);
    _1482.w = 1.0;
