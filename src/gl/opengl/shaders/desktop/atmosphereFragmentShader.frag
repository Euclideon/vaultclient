...
void main()
{
    ...
    vec3 _183 = u_fragParams.u_camera.xyz + (_131 * _181);
    vec3 _184 = u_fragParams.u_camera.xyz - u_fragParams.u_earthCenter.xyz;
    ...
    vec3 _203 = _199 - u_fragParams.u_earthCenter.xyz;
    vec3 _204 = normalize(_203);
    vec3 _212 = vec3(_139.xy, float(int(sign(_139.w))) * sqrt(1.0 - dot(_167, _167)));
    _212.y = _139.y * (-1.0);
    vec3 _213 = mat3(normalize(cross(u_fragParams.u_earthNorth.xyz, _204)), u_fragParams.u_earthNorth.xyz, _204) * _212;
    bool _214 = _144 < 0.75;
    vec3 _802;
    if (_214)
    {
        vec3 _217 = _183 - u_fragParams.u_earthCenter.xyz;
        ...
        vec4 _235 = texture(SPIRV_Cross_CombinedirradianceTextureirradianceSampler, vec2(0.0078125 + (((_222 * 0.5) + 0.5) * 0.984375), 0.03125 + (((_220 - u_fragParams.u_earthCenter.w) / _224) * 0.9375)));
        float _242 = u_fragParams.u_earthCenter.w / _220;
        float _248 = _118 * _118;
        float _250 = sqrt(_248 - _190);
        float _251 = _220 * _220;
        float _254 = sqrt(max(_251 - _190, 0.0));
        float _265 = _118 - _220;
        vec4 _278 = texture(SPIRV_Cross_CombinedtransmittanceTexturetransmittanceSampler, vec2(0.001953125 + (((max(((-_220) * _222) + sqrt(max((_251 * ((_222 * _222) - 1.0)) + _248, 0.0)), 0.0) - _265) / ((_254 + _250) - _265)) * 0.99609375), 0.0078125 + ((_254 / _250) * 0.984375)));
        float _295 = max(0.0, min(0.0, _181));
        vec3 _298 = normalize(_217 - _184);
        ...
        switch (0u)
        {
            ...
            {
                _334 = (2.0 * _316) * _317;
                float _339 = clamp(sqrt((_322 * (_322 + _334)) + _324), u_fragParams.u_earthCenter.w, _118);
                float _342 = clamp((_315 + _322) / _339, -1.0, 1.0);
                if (_330)
                {
                    float _400 = -_342;
                    float _401 = _339 * _339;
                    float _404 = sqrt(max(_401 - _190, 0.0));
                    float _415 = _118 - _339;
                    float _429 = -_317;
                    float _432 = sqrt(max(_324 - _190, 0.0));
                ...
                {
                    float _348 = sqrt(max(_324 - _190, 0.0));
                    float _356 = _118 - _316;
                    float _370 = _339 * _339;
                    float _373 = sqrt(max(_370 - _190, 0.0));
        ...
        float _462 = sqrt(max(_324 - _190, 0.0));
        ...
        float _514 = (max((_506 * _319) + sqrt(max((_190 * ((_319 * _319) - 1.0)) + _248, 0.0)), 0.0) - _224) / _513;
        float _516 = (0.415823996067047119140625 * u_fragParams.u_earthCenter.w) / _513;
        float _523 = 0.015625 + ((max(1.0 - (_514 / _516), 0.0) / (1.0 + _514)) * 0.96875);
        float _525 = (_320 + 1.0) * 3.5;
        float _526 = floor(_525);
        float _527 = _525 - _526;
        float _531 = _526 + 1.0;
        vec4 _537 = texture(SPIRV_Cross_CombinedscatteringTexturescatteringSampler, vec3((_526 + _523) * 0.125, _501, _465));
        float _538 = 1.0 - _527;
        vec4 _541 = texture(SPIRV_Cross_CombinedscatteringTexturescatteringSampler, vec3((_531 + _523) * 0.125, _501, _465));
        vec4 _543 = (_537 * _538) + (_541 * _527);
        vec3 _544 = _543.xyz;
        vec3 _557;
        switch (0u)
        {
        ...
        float _559 = max(_322 - _295, 0.0);
        float _564 = clamp(sqrt((_559 * (_559 + _334)) + _324), u_fragParams.u_earthCenter.w, _118);
        float _565 = _315 + _559;
        float _568 = (_318 + (_559 * _320)) / _564;
        float _569 = _564 * _564;
        float _572 = sqrt(max(_569 - _190, 0.0));
        ...
        float _622 = (max((_506 * _568) + sqrt(max((_190 * ((_568 * _568) - 1.0)) + _248, 0.0)), 0.0) - _224) / _513;
        float _629 = 0.015625 + ((max(1.0 - (_622 / _516), 0.0) / (1.0 + _622)) * 0.96875);
        vec4 _637 = texture(SPIRV_Cross_CombinedscatteringTexturescatteringSampler, vec3((_526 + _629) * 0.125, _611, _575));
        vec4 _640 = texture(SPIRV_Cross_CombinedscatteringTexturescatteringSampler, vec3((_531 + _629) * 0.125, _611, _575));
        vec4 _642 = (_637 * _538) + (_640 * _527);
        vec3 _643 = _642.xyz;
        vec3 _656;
        switch (0u)
        {
        ...
        if (_295 > 0.0)
        {
            ...
            switch (0u)
            {
                default:
                {
                    float _663 = clamp(_565 / _564, -1.0, 1.0);
                    if (_330)
                    {
                        float _712 = -_663;
        ...
        vec3 _765 = _544 - (_763 * _643);
        vec3 _767 = _557 - (_763 * _656);
        float _768 = _767.x;
        float _769 = _765.x;
        vec3 _784;
        switch (0u)
    ...
    if (_194)
    {
        ...
        vec4 _823 = texture(SPIRV_Cross_CombinedirradianceTextureirradianceSampler, vec2(0.0078125 + (((_810 * 0.5) + 0.5) * 0.984375), 0.03125 + (((_808 - u_fragParams.u_earthCenter.w) / _812) * 0.9375)));
        float _830 = u_fragParams.u_earthCenter.w / _808;
        float _836 = _118 * _118;
        float _838 = sqrt(_836 - _190);
        float _839 = _808 * _808;
        float _842 = sqrt(max(_839 - _190, 0.0));
        float _853 = _118 - _808;
        vec4 _866 = texture(SPIRV_Cross_CombinedtransmittanceTexturetransmittanceSampler, vec2(0.001953125 + (((max(((-_808) * _810) + sqrt(max((_839 * ((_810 * _810) - 1.0)) + _836, 0.0)), 0.0) - _853) / ((_842 + _838) - _853)) * 0.99609375), 0.0078125 + ((_842 / _838) * 0.984375)));
        vec3 _884 = normalize(_203 - _184);
        ...
        switch (0u)
        {
            ...
            {
                _920 = (2.0 * _902) * _903;
                float _925 = clamp(sqrt((_908 * (_908 + _920)) + _910), u_fragParams.u_earthCenter.w, _118);
                float _928 = clamp((_901 + _908) / _925, -1.0, 1.0);
                if (_916)
                {
                    float _986 = -_928;
                    float _987 = _925 * _925;
                    float _990 = sqrt(max(_987 - _190, 0.0));
                    float _1001 = _118 - _925;
                    float _1015 = -_903;
                    float _1018 = sqrt(max(_910 - _190, 0.0));
                ...
                {
                    float _934 = sqrt(max(_910 - _190, 0.0));
                    float _942 = _118 - _902;
                    float _956 = _925 * _925;
                    float _959 = sqrt(max(_956 - _190, 0.0));
        ...
        float _1048 = sqrt(max(_910 - _190, 0.0));
        ...
        float _1100 = (max((_1092 * _905) + sqrt(max((_190 * ((_905 * _905) - 1.0)) + _836, 0.0)), 0.0) - _812) / _1099;
        ...
        float _1149 = clamp(sqrt((_1144 * (_1144 + _920)) + _910), u_fragParams.u_earthCenter.w, _118);
        float _1150 = _901 + _1144;
        float _1153 = (_904 + (_1144 * _906)) / _1149;
        float _1154 = _1149 * _1149;
        float _1157 = sqrt(max(_1154 - _190, 0.0));
        ...
        float _1207 = (max((_1092 * _1153) + sqrt(max((_190 * ((_1153 * _1153) - 1.0)) + _836, 0.0)), 0.0) - _812) / _1099;
    ...
    switch (0u)
    {
        default:
        {
            ...
            float _1320 = sqrt(max(_1309 - _190, 0.0));
            float _1328 = _118 - _1303;
            float _1331 = (_1320 + _1317) - _1328;
            float _1333 = _1320 / _1317;
            vec4 _1341 = texture(SPIRV_Cross_CombinedtransmittanceTexturetransmittanceSampler, vec2(0.001953125 + (((max(((-_1303) * _1304) + sqrt(max(_1312 + _1287, 0.0)), 0.0) - _1328) / _1331) * 0.99609375), 0.0078125 + (_1333 * 0.984375)));
            vec3 _1342 = _1341.xyz;
            ...
            float _1393 = (max(((-u_fragParams.u_earthCenter.w) * _1306) + sqrt(max((_190 * ((_1306 * _1306) - 1.0)) + _1287, 0.0)), 0.0) - _1390) / _1392;
            float _1402 = 0.015625 + ((max(1.0 - (_1393 / ((0.415823996067047119140625 * u_fragParams.u_earthCenter.w) / _1392)), 0.0) / (1.0 + _1393)) * 0.96875);
            float _1404 = (_1307 + 1.0) * 3.5;
            float _1405 = floor(_1404);
            float _1406 = _1404 - _1405;
            vec4 _1416 = texture(SPIRV_Cross_CombinedscatteringTexturescatteringSampler, vec3((_1405 + _1402) * 0.125, _1379, _1346));
            vec4 _1420 = texture(SPIRV_Cross_CombinedscatteringTexturescatteringSampler, vec3(((_1405 + 1.0) + _1402) * 0.125, _1379, _1346));
            vec4 _1422 = (_1416 * (1.0 - _1406)) + (_1420 * _1406);
            vec3 _1423 = _1422.xyz;
            vec3 _1436;
            switch (0u)
            {
                default:
    ...
    vec3 _1475 = pow(abs(vec3(1.0) - exp(((-mix(mix(_1457, _1278, vec3(float(_194))), _802, vec3(float(_214) * min(1.0, 1.0 - smoothstep(0.64999997615814208984375, 0.75, _144))))) / u_fragParams.u_whitePoint.xyz) * u_fragParams.u_camera.w)), vec3(0.4545454680919647216796875));
    vec4 _1477 = vec4(_1475.x, _1475.y, _1475.z, _110.w);
    _1477.w = 1.0;
    vec4 _1486;
    if ((_1284 < u_fragParams.u_earthCenter.w) && (_185 <= 0.0))
    {
        vec3 _1484 = pow(_175.xyz, vec3(0.5));
