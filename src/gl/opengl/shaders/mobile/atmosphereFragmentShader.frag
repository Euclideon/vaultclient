...
uniform highp sampler2D SPIRV_Cross_Combinedirradiance_textureTextureirradiance_textureSampler;
uniform highp sampler2D SPIRV_Cross_Combinedtransmittance_textureTexturetransmittance_textureSampler;
uniform highp sampler3D SPIRV_Cross_Combinedscattering_textureTexturescattering_textureSampler;
...
void main()
{
    ...
    if (_163)
    {
        ...
        highp vec4 _187 = texture(SPIRV_Cross_Combinedirradiance_textureTextureirradiance_textureSampler, vec2(0.0078125 + (((_174 * 0.5) + 0.5) * 0.984375), 0.03125 + (((_172 - u_fragParams.u_earthCenter.w) / _176) * 0.9375)));
        ...
        highp vec4 _231 = texture(SPIRV_Cross_Combinedtransmittance_textureTexturetransmittance_textureSampler, vec2(0.001953125 + (((max(((-_172) * _174) + sqrt(max((_204 * ((_174 * _174) - 1.0)) + _200, 0.0)), 0.0) - _218) / ((_207 + _203) - _218)) * 0.99609375), 0.0078125 + ((_207 / _203) * 0.984375)));
        ...
        switch (0u)
        {
            default:
            {
                ...
                if (_280)
                {
                    ...
                    _409 = min(texture(SPIRV_Cross_Combinedtransmittance_textureTexturetransmittance_textureSampler, vec2(0.001953125 + (((max(((-_289) * _350) + sqrt(max((_351 * ((_350 * _350) - 1.0)) + _200, 0.0)), 0.0) - _365) / ((_354 + _203) - _365)) * 0.99609375), 0.0078125 + ((_354 / _203) * 0.984375))).xyz / texture(SPIRV_Cross_Combinedtransmittance_textureTexturetransmittance_textureSampler, vec2(0.001953125 + (((max(((-_266) * _379) + sqrt(max((_274 * ((_379 * _379) - 1.0)) + _200, 0.0)), 0.0) - _393) / ((_382 + _203) - _393)) * 0.99609375), 0.0078125 + ((_382 / _203) * 0.984375))).xyz, vec3(1.0));
                    break;
                }
                else
                {
                    ...
                    _409 = min(texture(SPIRV_Cross_Combinedtransmittance_textureTexturetransmittance_textureSampler, vec2(0.001953125 + (((max(((-_266) * _267) + sqrt(max(_277 + _200, 0.0)), 0.0) - _306) / ((_298 + _203) - _306)) * 0.99609375), 0.0078125 + ((_298 / _203) * 0.984375))).xyz / texture(SPIRV_Cross_Combinedtransmittance_textureTexturetransmittance_textureSampler, vec2(0.001953125 + (((max(((-_289) * _292) + sqrt(max((_320 * ((_292 * _292) - 1.0)) + _200, 0.0)), 0.0) - _334) / ((_323 + _203) - _334)) * 0.99609375), 0.0078125 + ((_323 / _203) * 0.984375))).xyz, vec3(1.0));
                    break;
                }
            }
        }
        ...
        highp vec4 _487 = texture(SPIRV_Cross_Combinedscattering_textureTexturescattering_textureSampler, vec3((_476 + _473) * 0.125, _451, _415));
        highp float _488 = 1.0 - _477;
        highp vec4 _491 = texture(SPIRV_Cross_Combinedscattering_textureTexturescattering_textureSampler, vec3((_481 + _473) * 0.125, _451, _415));
        ...
        highp vec4 _586 = texture(SPIRV_Cross_Combinedscattering_textureTexturescattering_textureSampler, vec3((_476 + _578) * 0.125, _560, _524));
        highp vec4 _589 = texture(SPIRV_Cross_Combinedscattering_textureTexturescattering_textureSampler, vec3((_481 + _578) * 0.125, _560, _524));
    ...
    if (_653)
    {
        ...
        highp vec4 _677 = texture(SPIRV_Cross_Combinedirradiance_textureTextureirradiance_textureSampler, vec2(0.0078125 + (((_664 * 0.5) + 0.5) * 0.984375), 0.03125 + (((_662 - u_fragParams.u_earthCenter.w) / _666) * 0.9375)));
        ...
        highp vec4 _720 = texture(SPIRV_Cross_Combinedtransmittance_textureTexturetransmittance_textureSampler, vec2(0.001953125 + (((max(((-_662) * _664) + sqrt(max((_693 * ((_664 * _664) - 1.0)) + _690, 0.0)), 0.0) - _707) / ((_696 + _692) - _707)) * 0.99609375), 0.0078125 + ((_696 / _692) * 0.984375)));
        ...
        switch (0u)
        {
            default:
            {
                ...
                if (_772)
                {
                    ...
                    _901 = min(texture(SPIRV_Cross_Combinedtransmittance_textureTexturetransmittance_textureSampler, vec2(0.001953125 + (((max(((-_781) * _842) + sqrt(max((_843 * ((_842 * _842) - 1.0)) + _690, 0.0)), 0.0) - _857) / ((_846 + _692) - _857)) * 0.99609375), 0.0078125 + ((_846 / _692) * 0.984375))).xyz / texture(SPIRV_Cross_Combinedtransmittance_textureTexturetransmittance_textureSampler, vec2(0.001953125 + (((max(((-_758) * _871) + sqrt(max((_766 * ((_871 * _871) - 1.0)) + _690, 0.0)), 0.0) - _885) / ((_874 + _692) - _885)) * 0.99609375), 0.0078125 + ((_874 / _692) * 0.984375))).xyz, vec3(1.0));
                    break;
                }
                else
                {
                    ...
                    _901 = min(texture(SPIRV_Cross_Combinedtransmittance_textureTexturetransmittance_textureSampler, vec2(0.001953125 + (((max(((-_758) * _759) + sqrt(max(_769 + _690, 0.0)), 0.0) - _798) / ((_790 + _692) - _798)) * 0.99609375), 0.0078125 + ((_790 / _692) * 0.984375))).xyz / texture(SPIRV_Cross_Combinedtransmittance_textureTexturetransmittance_textureSampler, vec2(0.001953125 + (((max(((-_781) * _784) + sqrt(max((_812 * ((_784 * _784) - 1.0)) + _690, 0.0)), 0.0) - _826) / ((_815 + _692) - _826)) * 0.99609375), 0.0078125 + ((_815 / _692) * 0.984375))).xyz, vec3(1.0));
                    break;
                }
            }
        }
        ...
        highp vec4 _979 = texture(SPIRV_Cross_Combinedscattering_textureTexturescattering_textureSampler, vec3((_968 + _965) * 0.125, _943, _907));
        highp float _980 = 1.0 - _969;
        highp vec4 _983 = texture(SPIRV_Cross_Combinedscattering_textureTexturescattering_textureSampler, vec3((_973 + _965) * 0.125, _943, _907));
        ...
        highp vec4 _1079 = texture(SPIRV_Cross_Combinedscattering_textureTexturescattering_textureSampler, vec3((_968 + _1071) * 0.125, _1053, _1017));
        highp vec4 _1082 = texture(SPIRV_Cross_Combinedscattering_textureTexturescattering_textureSampler, vec3((_973 + _1071) * 0.125, _1053, _1017));
            ...
            switch (0u)
            {
                default:
                {
                    ...
                    if (_772)
                    {
                        ...
                        _1204 = min(texture(SPIRV_Cross_Combinedtransmittance_textureTexturetransmittance_textureSampler, vec2(0.001953125 + (((max(((-_1006) * _1154) + sqrt(max((_1011 * ((_1154 * _1154) - 1.0)) + _690, 0.0)), 0.0) - _1165) / ((_1014 + _692) - _1165)) * 0.99609375), 0.0078125 + (_1015 * 0.984375))).xyz / texture(SPIRV_Cross_Combinedtransmittance_textureTexturetransmittance_textureSampler, vec2(0.001953125 + (((max(((-_758) * _1178) + sqrt(max((_766 * ((_1178 * _1178) - 1.0)) + _690, 0.0)), 0.0) - _1189) / ((_904 + _692) - _1189)) * 0.99609375), 0.0078125 + (_905 * 0.984375))).xyz, vec3(1.0));
                        break;
                    }
                    else
                    {
                        ...
                        _1204 = min(texture(SPIRV_Cross_Combinedtransmittance_textureTexturetransmittance_textureSampler, vec2(0.001953125 + (((max(((-_758) * _759) + sqrt(max(_769 + _690, 0.0)), 0.0) - _1116) / ((_904 + _692) - _1116)) * 0.99609375), 0.0078125 + (_905 * 0.984375))).xyz / texture(SPIRV_Cross_Combinedtransmittance_textureTexturetransmittance_textureSampler, vec2(0.001953125 + (((max(((-_1006) * _1105) + sqrt(max((_1011 * ((_1105 * _1105) - 1.0)) + _690, 0.0)), 0.0) - _1139) / ((_1014 + _692) - _1139)) * 0.99609375), 0.0078125 + (_1015 * 0.984375))).xyz, vec3(1.0));
                        break;
                    }
                }
            }
    ...
    switch (0u)
    {
        default:
        {
            ...
            highp vec4 _1305 = texture(SPIRV_Cross_Combinedtransmittance_textureTexturetransmittance_textureSampler, vec2(0.001953125 + (((max(((-_1267) * _1268) + sqrt(max(_1276 + _1251, 0.0)), 0.0) - _1292) / _1295) * 0.99609375), 0.0078125 + (_1297 * 0.984375)));
            ...
            highp vec4 _1380 = texture(SPIRV_Cross_Combinedscattering_textureTexturescattering_textureSampler, vec3((_1369 + _1366) * 0.125, _1343, _1310));
            highp vec4 _1384 = texture(SPIRV_Cross_Combinedscattering_textureTexturescattering_textureSampler, vec3(((_1369 + 1.0) + _1366) * 0.125, _1343, _1310));
