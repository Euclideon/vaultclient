...
void main()
{
    highp vec3 _85 = normalize(((texture(SPIRV_Cross_Combinedu_normalMapsampler0, varying_TEXCOORD0).xyz * vec3(2.0)) - vec3(1.0)) + ((texture(SPIRV_Cross_Combinedu_normalMapsampler0, varying_TEXCOORD1).xyz * vec3(2.0)) - vec3(1.0)));
