...
udResult vcCompass_Create(vcAnchor **ppCompass)
{
  ...
  UD_ERROR_IF(!vcShader_CreateFromFile(&pCompass->pShader, "asset://assets/shaders/compassVertexShader", "asset://assets/shaders/compassFragmentShader", vcP3N3VertexLayout), udR_InvalidConfiguration);
