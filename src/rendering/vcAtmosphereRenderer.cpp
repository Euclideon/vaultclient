...
bool vcAtmosphereRenderer_Render(vcAtmosphereRenderer *pAtmosphereRenderer, vcState *pProgramState, vcTexture *pSceneColour, vcTexture *pSceneNormal, vcTexture *pSceneDepth)
{
  ...
  pAtmosphereRenderer->renderShader.fragParams.earthUp.x = (float)pProgramState->camera.cameraUp.x;
  pAtmosphereRenderer->renderShader.fragParams.earthUp.y = (float)pProgramState->camera.cameraUp.y;
  pAtmosphereRenderer->renderShader.fragParams.earthUp.z = (float)pProgramState->camera.cameraUp.z;
