...
void vcPolyModelNode::ApplyDelta(vcState *pProgramState, const udDouble4x4 &delta)
{
  ...
  vcProject_UpdateNodeGeometryFromCartesian(pProgramState->activeProject.pProject[pProgramState->eCurrentProjectIndex], m_pNode, pProgramState->gis.zone, vdkPGT_Point, &position, 1);
