...
if [ $OSTYPE == "msys" ]; then # Windows, MingW
	export VAULTSDK_HOME="//bne-fs-fs-003.euclideon.local/Resources/Builds/vault/sdk/Pipeline_24355"
	...
	export VAULTSDK_HOME="/mnt/Resources/Builds/vault/sdk/Pipeline_24355"
